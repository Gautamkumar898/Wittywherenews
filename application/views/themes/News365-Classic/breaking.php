            ...
            <div class="col-sm-4 col-md-3">
                <div class="top_header_menu_wrap">
                    <ul class="top-header-menu">
                        <li><a href="<?php echo base_url();?>login-register" target="__blank"><span class="glyphicon glyphicon-log-in"></span> LOGIN </a></li>
                        <li><a href="<?php echo base_url();?>login-register"><?php echo display('login_and_registration')?></a></li>
