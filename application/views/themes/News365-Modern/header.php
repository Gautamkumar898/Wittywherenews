...
<html lang="en">
    <head>
        ...
        <!-- Scrollbar css -->
        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/web-assets/css/jquery.mCustomScrollbar.css"/>
        <!-- Owl Carousel css -->
        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/web-assets/owl-carousel/owl.carousel.css"/>
        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/web-assets/owl-carousel/owl.theme.css"/>
        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/web-assets/owl-carousel/owl.transitions.css"/>
        <!-- youtube css -->
        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/web-assets/css/RYPP.css"/>
        <!-- jquery-ui css --> 
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/web-assets/css/jquery-ui.css">
        <!-- animate -->
        <!-- toster -->
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/web-assets/toster/toastr.css">
        
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/web-assets/css/animate.min.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/web-assets/css/comments.css">
        <!-- fonts css -->
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/web-assets/font-awesome/css/font-awesome.min.css">
        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/web-assets/css/Pe-icon-7-stroke.css"/>
        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/web-assets/css/flaticon.css"/>
        <!-- custom css -->
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/web-assets/css/comments.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/web-assets/css/style.css">
        <!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/web-assets/js/jquery.min.js"></script>
