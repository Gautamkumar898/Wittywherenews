                ...
                <li class="treeview ml">
                    ...
                    <ul class="treeview-menu media_library">
                        ...
                        <li <?php echo (($slug == 'Photo_list') ? $selected : '')?>><a href="<?php echo $bu; ?>admin/Photo_list"><i class="fa fa-angle-double-right"></i> <?php echo display('picture_list')?></a></li>
                            ...
                            <li <?php echo (($slug == 'Video_list') ? $selected : '')?>><a href="<?php echo $bu; ?>admin/Video_upload"><i class="fa fa-angle-double-right"></i> <?php echo ('Add  Videos')?></a></li>
                                <li <?php echo (($slug == 'Video_list') ? $selected : '')?>><a href="<?php echo $bu; ?>admin/Video_list"><i class="fa fa-angle-double-right"></i> <?php echo (' Videos List')?></a></li>
                    </ul>
                </li>
